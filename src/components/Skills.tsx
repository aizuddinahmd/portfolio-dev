...
import { 
  FaHtml5, FaCss3Alt, FaJs, FaReact, FaNodeJs, FaPython, FaGitAlt, FaAws 
} from 'react-icons/fa';
import { 
  SiTypescript, SiNextdotjs, SiTailwindcss, SiFirebase, SiMongodb, SiPostgresql, SiPrisma, SiDocker 
} from 'react-icons/si';
...
const Skills = () => {
  return (
    <section id="skills" className="relative py-10 lg:py-16 xl:py-20 bg-black text-white">
