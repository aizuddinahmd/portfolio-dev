...
const skills = [
  ...
  { id: "9", title: "Supabase", icon: SiSupabase, color: "#3FCF8E" },
  { id: "10", title: "N8N", icon: SiN8N, color: "#47A248" },
      ...
      <div className="container mx-auto px-4 relative z-2">
        ...
        <div className="flex flex-wrap justify-center gap-6 md:gap-10">
          {skills.map((item) => (
            <div
              key={item.id}
              className="group relative flex items-center justify-center w-20 h-20 md:w-24 md:h-24 rounded-2xl bg-black border border-white/10 hover:border-white/20 transition-all duration-300 hover:-translate-y-1"
            >
